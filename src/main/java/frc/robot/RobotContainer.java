...
public class RobotContainer {
  ...
  private void configureBindings() {
    // Intake Command
    new JoystickButton(m_operatorController, 0).whileTrue(new IntakeCommand(m_intakeSubsystem));
    ...
    new JoystickButton(m_operatorController, 2).whileTrue(new ClimbCommand(m_climbSubsystem, true));
